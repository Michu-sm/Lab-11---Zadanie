...
namespace Kadry1
{
    ...
    class Osoba
    {
        ...
        public Osoba(int numerEwidencyjny, string imie, string nazwisko,
        int numerDomu, int? numerMieszkania, string nazwaUlicy,
        string kod, string miejscowosc)
        {
            this.numerEwidencyjny = numerEwidencyjny;
            this.imie = imie;
            this.nazwisko = nazwisko;
            adresZamieszkania = new Adres(numerDomu, numerMieszkania,
                                          nazwaUlicy, kod, miejscowosc);
        }

        public Osoba(int numerEwidencyjny, string imie, string nazwisko,
        Adres adres)
            : this(numerEwidencyjny, imie, nazwisko, adres.ZwrocNumerDomu(),
                  adres.ZwrocNumerMieszkania(), adres.ZwrocNazweUlicy(),
                  adres.ZwrocKod(), adres.ZwrocMiejscowosc())
        {
        }

        public Osoba(int numerEwidencyjny, string imie, int numerDomu)
            : this(numerEwidencyjny, imie, "Kowalski", numerDomu, null,
                  "Aleje Jerozolimskie", "02-222", "Warszawa")
        {
        }
        ...
        {
            return string.Format("Pan(i) {0} {1} o numerze ewidencyjnym {2} \n" +
                                "zamieszkały(a): {3}", imie, nazwisko, numerEwidencyjny,
